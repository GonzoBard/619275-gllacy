...
![Результат защиты](img/result_defence.png)<br>

# Изменения в проекте после защиты

* В фильтрах оживил ценовой диапазон, был использован плагин [noUiSlider](https://refreshless.com/nouislider/) 
